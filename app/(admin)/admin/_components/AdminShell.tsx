...
import {
  ...
  AdminTabNavProvider,
  useAdminTabNav,
} from "@/app/(admin)/admin/_components/AdminTabNav";
...
function AdminShellFrame({
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#0a0e14] text-white">
      <aside className="sticky top-0 hidden h-screen w-56 shrink-0 flex-col overflow-hidden border-r border-zinc-800 bg-[#0a0e14] lg:flex">
